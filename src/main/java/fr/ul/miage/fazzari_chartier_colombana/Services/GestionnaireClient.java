...
public class GestionnaireClient {
    ...
    public static void ajouterClient() {
        ...
        boolean boucle = true; String nom = null;
        while (boucle) {
        ...
        boucle = true; String prenom = null;
        while (boucle) {
        ...
        boucle = true; String adresse = null;
        while (boucle) {
        ...
        boucle = true; String telephone = null;
        while (boucle) {
